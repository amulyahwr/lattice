...
export const CACHE_TIER_CONFIG = {
  L2: { label: '⚡ Cache hit', color: 'text-green-400', bg: 'bg-green-500/15 border-green-500/30' },
  L3: { label: '🔍 Index search', color: 'text-yellow-400', bg: 'bg-yellow-500/15 border-yellow-500/30' },
} as const
